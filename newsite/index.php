      ...
      <div class="row">
        <div class="grid col-xs-12">
          ...
          <div class="grid-item col-xs-12 col-sm-2 col-md-2 col-lg-2">
            <a href="#sample" class="trigger hidden-xs"><img src="samples/actual_ones/quads/sample_quads_small.png" alt="sample_quads_small" width="500" height="500"></a>
            <div class="infopane visible-xs">
              <div class="owl-carousel">
                <div class="imagewrapper"><img src="samples/actual_ones/quads/sample_quads.jpg" alt="sample_quads" width="1600" height="900"></div>
          ...
          <div class="grid-item col-xs-12 col-sm-2 col-md-2 col-lg-2 initial">
            <a href="#sample" class="trigger hidden-xs hidden-xs"><img src="samples/actual_ones/edgefolio/sample.png" alt="sample" width="500" height="500"></a>
            <div class="infopane visible-xs visible-xs">
              <div class="owl-carousel owl-theme">
                <div class="imagewrapper"><img src="samples/actual_ones/edgefolio/sample_large.jpg" alt="sample_large" width="1600" height="900"></div>
...
Django Rest API and data importer by Harish Narayanan and Bastien Bourdon.</p>
          ...
          <div class="grid-item col-xs-12 col-sm-2 col-md-2 col-lg-2">
            <a href="#sample" class="trigger hidden-xs"><img src="samples/actual_ones/desktop_hydroponics/sample.jpg" alt="sample" width="500" height="500"></a>
            <div class="infopane visible-xs">
              <div class="owl-carousel">
          ...
          <div class="grid-item col-xs-12 col-sm-2 col-md-2 col-lg-2">
            <a href="#sample" class="trigger hidden-xs"><img src="samples/actual_ones/koffaein/fb_1667x1667_alt.jpg" alt="fb_1667x1667_alt" width="500" height="500"></a>
            <div class="infopane visible-xs">
              <div class="owl-carousel">
                <div class="imagewrapper"><img src="samples/actual_ones/koffaein/sample_large.jpg" alt="sample_large" width="1600" height="900"></div>
                <div class="imagewrapper"></div>
                <div class="videowrapper"></div>
                <div class="imagewrapper"></div>
                <div class="imagewrapper"></div>
          ...
          <div class="grid-item col-xs-12 col-sm-2 col-md-2 col-lg-2">
            <a href="#sample" class="trigger hidden-xs"><img src="samples/actual_ones/xjazz/sample.jpg" alt="sample" width="500" height="500"></a>
            <div class="infopane visible-xs">
              <div class="owl-carousel">
                <div class="imagewrapper"><img src="samples/actual_ones/xjazz/sample_large.jpg" alt="sample_large" width="1600" height="900"></div>
                <div class="imagewrapper"></div>
                <div class="videowrapper"></div>
                <div class="imagewrapper"></div>
                <div class="imagewrapper"></div>
