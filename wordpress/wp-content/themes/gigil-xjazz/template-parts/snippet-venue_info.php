<?php
/**
 * The default template for displaying venue text
 */
?>
  <div>
    <h1><?php the_title(); ?></h1>
    <div class="col-xs-12 noPadding">
      <div class="col-xs-6 noPadding">
        <?php echo get_previous_post_link('%link', '&laquo; Previous venue'); ?>
      </div>
      <div class="col-xs-6 noPadding text-right">
        <?php echo get_next_post_link('%link', 'Next venue &raquo;'); ?>
      </div>
    </div>
    <div>
      <?php the_content(); ?>
